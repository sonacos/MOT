...
export const TASK_GROUPS: TaskGroup[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 27, description: 'Céréales, mais, l\'orge, luzerne, légumineuse, riz(50 kg)', unit: 'par quintal', price: 1.40 },
      { id: 28, description: 'Mais, orge, luzerne, légumineuse, riz(25 à 40 kg)', unit: 'par quintal', price: 1.55 },
      ...
      { id: 32, description: 'Engrais', unit: 'par quintal', price: 1.10 },
    ],
  },
    {
